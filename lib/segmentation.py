...
__all__ = ['lavt', 'lavt_one', 'swin']


def swin(pretrained, args):
    ...
    if pretrained:
        print('Initializing uni-modal Swin Transformer weights from ' + pretrained)
        backbone.init_weights(pretrained=pretrained)
    else:
        print('Randomly initialize uni-modal Swin Transformer weights.')
